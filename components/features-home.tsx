...
import TargetImage from "@/public/images/Prompts.png";
import PromptImage from "@/public/images/Prompt SS.png";
import Resources from "@/app/(default)/resources";

export default function FeaturesHome() {
  return (
    //   <section className="mb-6 relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
    // <div className="mx-auto max-w-6xl px-4 sm:px-6"></div>
    <section className="relative mb-6 before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div
        ...
        <div className="py-12 md:py-20">
          ...
          >
            <div className="absolute bottom-0 -z-10" aria-hidden="true">
              <div className="h-80 w-80 rounded-full blur-[160px]" />
            </div>
            <div className="aspect-video w-full -rotate-1 rounded-2xl 0 px-5 py-3 transition duration-300">
            ...
            <div className="absolute top-16">
              <div className="pointer-events-none mb-[7%] translate-y-2 transition duration-300  h-32">
                <Image
                  className="-rotate-2"
                  src={FeatureImg01}
                  width={500}
              ...
              <div className="delay-50 pointer-events-none mb-[3.5%] translate-y-2 transition duration-300  ">
                <Image src={FeatureImg02} width={500} alt="Overlay 02" />
              </div>
              <div className="pointer-events-none translate-y-2 transition delay-100 duration-300  ">
                <Image
                  className="-rotate-1"
                  src={PromptImage}
                  width={300}
